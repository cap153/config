 ...
 */
// static char *font = "Caskaydia Cove Nerd Font:pixelsize=24:antialias=true:autohint=true";
static char *font = "ComicShannsMono Nerd Font:pixelsize=23:antialias=true:autohint=true";
